...
function m1(){
	$("#titleBarMenu").html('<span id="containerTitleBarNew" onclick="m2()"> <i class="fa fa-file"> </i> New Photos');
...
function m2(){
	$("#titleBarMenu").html('<span id="containerTitleBarNew" onclick="m1()"> <i class="fa fa-file"> </i> View Photos');
	...
	$.ajax({
        ...
        success: function(result) {
        		...
        		try{
	        		...
	        		t1="<table align=center width=50% id='tbl' class='table table-hover dataTable no-footer'><thead><tr><th>Photo Group Name</th><th>Delete</th></tr></thead><tbody></tbody>";
        ...
        success: function(result) {
        	//alert(result);
	        	try{
						...
						snackbar("Photos added succesfully");
	        	}
	        	catch(e){
	        		snackbar("Something went wrong..");
	        	}
